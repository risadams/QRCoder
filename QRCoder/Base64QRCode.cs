...
namespace QRCoder
{
    public class Base64QRCode : AbstractQRCode, IDisposable
    {
        ...
        public string GetGraphic(int pixelsPerModule, Color darkColor, Color lightColor, bool drawQuietZones = true, ImageType imgType = ImageType.Png)
        {
            ...
            using (var bmp = qr.GetGraphic(pixelsPerModule, darkColor, lightColor, drawQuietZones)) base64 = BitmapToBase64(bmp, imgType);
            return base64;
        }
        ...
        {
            var base64                                                                                                                             = string.Empty;
            using (var bmp = qr.GetGraphic(pixelsPerModule, darkColor, lightColor, icon, iconSizePercent, iconBorderWidth, drawQuietZones)) base64 = BitmapToBase64(bmp, imgType);
            return base64;
        }
