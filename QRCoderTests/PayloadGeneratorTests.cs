...
namespace QRCoderTests
{
    public class PayloadGeneratorTests
    {
        ...
        public void bezahlcode_generator_can_generate_payload_singlepayment_minimal()
        {
            ...
            var generator = new PayloadGenerator.BezahlCode(AuthorityType.singlepayment, name, account, bnc: bnc, amount: amount);
        ...
        public void bezahlcode_generator_can_generate_payload_singlepaymentsepa_minimal()
        {
            ...
            var generator = new PayloadGenerator.BezahlCode(AuthorityType.singlepaymentsepa, name, iban, bic: bic, amount: amount);
        ...
        public void bezahlcode_generator_can_generate_payload_singledirectdebitsepa()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://singledirectdebitsepa?name=Wikimedia%20F%C3%B6rdergesellschaft&iban=DE33100205000001194700&bic=BFSWDE33BER&separeference=Fake%20SEPA%20reference&creditorid=DE%2002%20TSV%2001234567890&mandateid=987543CB2&dateofsignature=01032017&amount=10,00&reason=Thanks%20for%20all%20your%20efforts&currency=USD&executiondate=" +
        ...
        public void bezahlcode_generator_can_generate_payload_periodicsinglepaymentsepa()
        {
            ...
            generator
                .ToString()
                .ShouldBe("bank://periodicsinglepaymentsepa?name=Wikimedia%20F%C3%B6rdergesellschaft&iban=DE33100205000001194700&bic=BFSWDE33BER&separeference=Fake%20SEPA%20reference&amount=10,00&reason=Thanks%20for%20all%20your%20efforts&currency=USD&executiondate=" + DateTime.Now.ToString("ddMMyyyy") +
                          "&periodictimeunit=M&periodictimeunitrotation=1&periodicfirstexecutiondate=" + periodicFirstExecutionDate.ToString("ddMMyyyy") + "&periodiclastexecutiondate=" + periodicLastExecutionDate.ToString("ddMMyyyy"));
        }
        ...
        public void bezahlcode_generator_can_generate_payload_contact()
        {
            ...
            var generator = new PayloadGenerator.BezahlCode(AuthorityType.contact, name, account, bnc);
        ...
        public void bezahlcode_generator_can_generate_payload_contactv2_classic()
        {
            ...
            var generator = new PayloadGenerator.BezahlCode(AuthorityType.contact_v2, name, account, bnc);
        ...
        public void bezahlcode_generator_should_throw_wrong_nonsepa_constructor_exception()
        {
            ...
            var exception = Record.Exception(() => new PayloadGenerator.BezahlCode(AuthorityType.singlepaymentsepa, name, account, bnc: bnc, amount: amount));
        ...
        public void bezahlcode_generator_should_throw_wrong_sepa_constructor_exception()
        {
            ...
            var exception = Record.Exception(() => new PayloadGenerator.BezahlCode(AuthorityType.singlepayment, name, iban, bic: bic, amount: amount));
        ...
        public void bezahlcode_generator_should_throw_name_too_long_exception()
        {
            ...
            var exception = Record.Exception(() => new PayloadGenerator.BezahlCode(AuthorityType.singlepaymentsepa, name, iban, bic: bic, amount: amount));
        ...
        public void bezahlcode_generator_should_throw_reason_too_long_exception()
        {
            ...
            var exception = Record.Exception(() => new PayloadGenerator.BezahlCode(AuthorityType.singlepaymentsepa, name, iban, bic: bic, amount: amount, reason: reason));
        ...
        public void bezahlcode_generator_should_throw_invalid_account_exception()
        {
            ...
            var exception = Record.Exception(() => new PayloadGenerator.BezahlCode(AuthorityType.singlepayment, name, account, bnc: bnc, amount: amount));
        ...
        public void bezahlcode_generator_should_throw_invalid_postingkey_exception()
        {
            ...
            var exception = Record.Exception(() => new PayloadGenerator.BezahlCode(AuthorityType.singlepayment, name, account, bnc, amount, postingKey: postingKey));
        ...
        public void swissqrcode_generator_should_generate_contact_simple()
        {
            ...
            var generator = PayloadGenerator.SwissQrCode.Contact.WithStructuredAddress(name, zip, city, country);
